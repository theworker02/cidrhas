...
cidrhas is proprietary Product IP associated with `theworker02/cidrhas`. Acquisition value is the working materials, documentation, and a clear path to either a commercial license or an asset purchase â€” not an open-source community project.
